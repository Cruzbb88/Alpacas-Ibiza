...
| Newsletter subscriber confirmation email is fail-quiet | [app/api/newsletter/route.ts:37-45](app/api/newsletter/route.ts#L37-L45) | inner try/catch-warn; subscription still succeeds if confirmation fails |

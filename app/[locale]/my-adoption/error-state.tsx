...
const TITLES: Record<Props['reason'], string> = {
  'no-token': 'Portal link missing',
  expired: 'Portal link expired',
  'sdk-missing': 'Service starting up',
  'fetch-failed': 'Couldn\'t load your adoption',
}

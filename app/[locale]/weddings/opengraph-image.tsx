/**
 * Per-route OG image for /[locale]/weddings
...
export const alt = 'Alpacas at Your Wedding — Alpacas Ibiza'

export default function WeddingsOgImage() {

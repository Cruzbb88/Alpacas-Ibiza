/**
 * Per-route OG image for /[locale]/workshops
...
export const alt = 'Weaving + Spinning Workshops — Alpacas Ibiza'

export default function WorkshopsOgImage() {
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ fontSize: 68, fontWeight: 800, lineHeight: 1.05, margin: 0 }}>
            Weaving + Spinning Workshops
          </div>
          <div style={{ fontSize: 36, fontWeight: 400, opacity: 0.85 }}>
            2 days with San · Take home a scarf
          </div>
        </div>
